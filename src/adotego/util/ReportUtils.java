...
public class ReportUtils {
    ...
    public void abrirRelatorioAnimais() throws JRException {
         ...
         *
         */
        InputStream inputStream = getClass().getResourceAsStream("/relatorios/rel_animais.jasper");
        ...
        try {
            ...
            // abre o relatório
            ReportUtils.openReport("Relatório Animais", inputStream, parametros,
                    c = new ConnectionPool().getConnection());
